            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p style="margin: 0;">
                            Нажмите на кнопку для подтверждения адреса.
                            Или скопируйте ссылку и вставьте её в адресную строку.
                        </p>
                        <p>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="center" bgcolor="#e9ecef"
                        ...
                        <p style="margin: 0;">
                            Вы получили это письмо, потому что мы получили запрос на регистрацию с этим адресом.
                            Если это сделали не Вы, просто проигнорируйте или удалите это сообщение.
                        </p>
                    </td>
                </tr>
                <!-- end permission -->
